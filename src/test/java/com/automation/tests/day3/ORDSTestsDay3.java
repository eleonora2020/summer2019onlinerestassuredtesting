...
public class ORDSTestsDay3 {
    ...
    @BeforeAll // @BeforeAll must be static
    ...
    @Test
    public void test1() { //example for hamcrest
        given().
                accept("application/json").
                get("/employees").
        then().
                assertThat().statusCode(200).
                and().assertThat().contentType("application/json"). //assertThat
                log().all(true); //log.ifError(true) --> if there is an error, print information
    ...
    //query parameter - to filter results, or describe new resource: POST /users?name=James&age=60&job-title=SDET
